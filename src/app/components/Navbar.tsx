...
export default function Navbar({ onTerminalOpen }: NavbarProps) {
  ...
  useEffect(() => {
    try {
      ...
      if (saved === 'light') { setLight(true); document.documentElement.setAttribute('data-theme', 'light'); }
    } catch {}
  }, []);
    ...
    >
      <div className="mx-auto max-w-[900px] px-6 h-14 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-7">
          ...
          >
            <ThemeToggleIcon maskId="theme-mask-desktop" />
          </button>
        ...
        <div className="flex md:hidden items-center gap-3">
          <button
              ...
              aria-label="Toggle theme"
            >
              <ThemeToggleIcon maskId="theme-mask-mobile" />
          </button>
          <button
            onClick={onTerminalOpen}
...
function ThemeToggleIcon({ maskId }: { maskId: string }) {
  return (
    <svg
