      ...
      <div className="mx-auto max-w-[900px] px-6 w-full">
        ...
        <div className="flex items-center gap-3 flex-wrap hero-fade" style={{ animationDelay: '220ms' }}>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-sm px-5 py-2.5 rounded-lg border border-[var(--border-hover)] text-[var(--text-secondary)] hover:text-[var(--text)] hover:border-[var(--border-hover)] transition-all duration-200"
          >
