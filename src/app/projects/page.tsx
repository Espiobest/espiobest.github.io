...
const Projects = () => {
    ...
    const projects = [
        {
            ...
            'awards': 'Won the "Most Impactful Award" & $2,000 at UChicago Tech Showcase \'24 and "Best use of Github" at HackUMass'
        },
        {
            'title': 'Spotify Stats',
        ...
        {
            'title': 'Discord Bot',
            'description': 'A moderation bot for a Discord community of 30,000+, enhancing community safety and engagement',
    ...
    return (
        <div>
            <Container >
                <Typography variant="h5" className="text-center p-2" gutterBottom>
                    Discover My Projects
                </Typography>
                
                <div className="grid grid-cols-1 place-items-center projects-grid sm:grid-cols-2"> 
                    {projects.map((project, index) => (
                        <Card key={index} className="project-card">
                            <div style={{position: 'relative'}}>
                                <Image src={project.image} alt={project.title} width={200} height={150} className="project-image" />
                                {project.awards && (
                                <Tooltip title={project.awards} arrow className="absolute top-0 left-1 sm:left-10" enterTouchDelay={0} leaveTouchDelay={2000}>
                            ...
                            <CardContent>
                                ...
                                <Typography variant="body2" color="white" style={{textAlign: 'center'}} gutterBottom>
                                    {project.description}
                                </Typography>
                                <Typography variant="body2" color="#0070f3" style={{textAlign: 'center'}} gutterBottom>
                                    {project.technologies.join(', ')}
                                </Typography>
                                <div style={{display: 'flex', justifyContent: 'center'}}>
                                    <IconButton className={"project-link"} color="inherit" href={project.github} target="_blank">
                                        <GitHubIcon sx={{fontSize: 40}} />
                                    </IconButton>
                                    {project.link && 
                                        <IconButton className={"project-link"} color="inherit" href={project.link} target="_blank">
